...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
  {/* Existing Player Management card */}
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
  {/* Existing League Management card */}
  <div className="bg-white rounded-lg shadow-md p-6">
  ...
  {/* New Mock Drafts card */}
  <div className="bg-white rounded-lg shadow-md p-6">
    <h2 className="text-xl font-semibold mb-4">Mock Drafts</h2>
    <p className="text-gray-600 mb-4">
      Import and manage mock drafts from sportscasters for users to use as starting points.
    </p>
    <div className="flex flex-col space-y-3">
      <Link href="/manage-mock-drafts" className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded text-center">
        Manage Mock Drafts
      </Link>
    </div>
  </div>
