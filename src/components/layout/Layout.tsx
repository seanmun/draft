        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-500 text-xs mt-1">Fantasy sports draft prediction platform</p>
              <p className="text-gray-500 text-xs mt-1">Built and maintained by <a href="https://seanmun.com" target="_blank">Seanmun.com</a></p>
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <a href="https://github.com/seanmun" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
              ...
              <a href="https://linkedin.com/in/seanmun" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
